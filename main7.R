...
barplot(mn, beside = TRUE, col = colors, names.arg = xtag, main = "ascatNGS aberrations reported in {gene}", ylim = c(0,top))
dev.off()
...
png("ASCATi2_per_{gene}.png", width = 730, height = 554)
barplot(ma, beside = TRUE, col = colors, names.arg = xtag, main = "ASCAT2 aberrations reported in {gene}", ylim = c(0,100))
dev.off()
png("FACETS_per_{gene}.png", width = 730, height = 554)
barplot(mf, beside = TRUE, col = colors, names.arg = xtag, main = "FACETS aberrations reported in {gene}", ylim = c(0,100))
dev.off()
png("ascatNGS_per_{gene}.png", width = 730, height = 554)
barplot(mn, beside = TRUE, col = colors, names.arg = xtag, main = "ascatNGS aberrations reported in {gene}", ylim = c(0,100))
dev.off()
png("PURPLE_per_{gene}.png", width = 730, height = 554)
barplot(mp, beside = TRUE, col = colors, names.arg = xtag, main = "PURPLE aberrations reported in {gene}", ylim = c(0,100))
dev.off()
png("Sequenza_per_{gene}.png", width = 730, height = 554)
