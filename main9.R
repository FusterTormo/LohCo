...
png(width = 1261, height = 906, filename = paste(gene, "genePos.png", sep = " "))
...
png(width = 1261, height = 906, filename = paste(gene, " varType.png"))
...
png(width = 1261, height = 906, filename = paste(gene, "exonicVarType.png", sep = " "))
...
ggsave(filename = paste(gene, " varsXsubmitter.png"), device = "png", dpi = 320, width = 26, height = 26, units = "cm")
